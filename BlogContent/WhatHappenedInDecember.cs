    ...
    class WhatHappenedInDecember
    {
        public static string blogContent =
            ...
            <h3><b>NEXT:</b></h3>
             ...
             <p>I chose the one potentially positive option and entered an online chat with the Veterans’ Crisis Helpline (<a href=""https://www.veteranscrisisline.net/get-help/chat"" target=""_blank"">HERE</a>, for those who need it!!! It works!). Their concern was overwhelming and necessary. They immediately followed our internet discussion with a phone call and directed me to the VA hospital with instructions that if I did not report within 20 minutes, they would send authorities to seek me.</p>
             ...
             <p>— — Now, to overcome embarrassment that frankly I should not have ever felt, I’ve been telling people that I had attended in-person <i>rehab</i> at the VA. This is not exactly true. Having been identified as potentially harmful to myself, I was actually admitted to the VA’s mental health clinic. Which, to be honest, in past times, was referred to in much more derogatory terms: as in, <i>the psych ward</i>. — -</p>
            ...
            <ol>
            <li> For the therapeutic benefit that comes from streaming thoughts and emotions to words in a public way;</li>

            <li> To fill in some gaps for those who knew that something — but not what exactly — occurred to me in December; and</li>

            <li> To demonstrate that one can ascend from the deepest of depths.</li>
            </ol>
